...
tk.Label(det_frame, text="Event Name", font=("Fixedsys", 12), background="#D2D4DA").grid(column=0, row=0, sticky=W)
    #-entry_frame inputs-#
entry_1 = tk.Entry(entry_frame, font=("Fixedsys", 15), background="#E9E9ED")
...
spin_1 = Spinbox(entry_frame, from_=0, to=100, increment=1, wrap=YES, state="readonly", font=("Fixedsys"), readonlybackground="#E9E9ED", foreground="#FA6C38")
spin_2 = Spinbox(entry_frame, from_=0, to=100, increment=1, wrap=YES, state="readonly", font=("Fixedsys"), readonlybackground="#E9E9ED", foreground="#0656B1")
...
#Packs the latest scores onto the screen
def lead_function():
